...
class Tp
{
	...
	function __construct($conf,$log,$zonetpl="")
	{
		...
		if(file_exists("core/integrate/driver/class.tp.".$moteurlowercase.".php"))
		{
			include_once "core/integrate/driver/class.tp.".$moteurlowercase.".php";
			eval("\$this->tpselected=new Template".$moteurclass."();");
		}
		else
		{
			include_once "core/integrate/driver/class.tp.smarty.php";
