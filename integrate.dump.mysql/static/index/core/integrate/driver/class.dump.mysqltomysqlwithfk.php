...
require_once dirname(__FILE__).'/class.dump.mysqltomysql.php';

class DumpMysqlToMysqlwithfk extends DumpMysqlToMysql{
    ...
    */
    function __construct($conf = null, $filepath = 'dump.sql', $compress = false, $hexValue = false){
        parent::__construct($conf,$filepath,$compress,$hexValue);
        
        $this->_dbname = $conf['database']['maindb']['bd'];
