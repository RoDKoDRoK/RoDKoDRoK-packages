...
<a href="?page=form{$tablenom}&typeform=insert">Add {$tablenom}</a>
...
{literal}{/if}{/literal}
	<a href="?page=view{$tablenom}&id={literal}{$data[cpt].id{/literal}{$tablenom}{literal}}{/literal}">View {$tablenom}</a>
