...
class Contact extends ClassIniter
{
	var $preform=null;
	...
	function content_loader()
	{
		...
		$content.=$this->instanceLang->getTranslation("Contactez-nous !");
	...
	function getPreform()
	{
		...
		$preform['lineform'][count($preform['lineform'])-1]['label']=$this->instanceLang->getTranslation("Objet");
		$preform['lineform'][count($preform['lineform'])-1]['name']="objet";
		...
		$preform['lineform'][]=array();
		$preform['lineform'][count($preform['lineform'])-1]['label']=$this->instanceLang->getTranslation("Mail expéditeur");
		$preform['lineform'][count($preform['lineform'])-1]['name']="mail_expediteur";
		$preform['lineform'][count($preform['lineform'])-1]['default']="";
		$preform['lineform'][count($preform['lineform'])-1]['suggestlist']="";
		$preform['lineform'][count($preform['lineform'])-1]['champs']="mail";
		
		$preform['lineform'][]=array();
		$preform['lineform'][count($preform['lineform'])-1]['label']=$this->instanceLang->getTranslation("Message");
		$preform['lineform'][count($preform['lineform'])-1]['name']="message";
		$preform['lineform'][count($preform['lineform'])-1]['default']="";
		$preform['lineform'][count($preform['lineform'])-1]['suggestlist']="";
		$preform['lineform'][count($preform['lineform'])-1]['champs']="textarea";
