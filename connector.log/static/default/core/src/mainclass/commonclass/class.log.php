...
class Log
{
	...
	function __construct($conf,$db=null)
	{
		...
		if(file_exists("core/integrate/driver/class.log.".$moteurlowercase.".php"))
		{
			include_once "core/integrate/driver/class.log.".$moteurlowercase.".php";
			eval("\$this->logselected=new Log".$moteurclass."(\$conf,\$db);");
		}
		else
		{
			include_once "core/integrate/driver/class.log.nolog.php";
